...
% Divido e guardo os valores (divididos por espa�os em branco ou v�rgulas) representantes do numeros de neur�nios por cada camada
% CADA N�MERO REPRESENTA UMA CAMADA DE NEUR�NIOS
...
for k = 1:length(handles.idx)
    f_activacao(k) = handles.contents(handles.idx(k));  % copia as strings das fun��es de activa��o para um cell array auxiliar
end

num = get(handles.listbox2, 'Value');                  % retorna o(s) indice(s) seleccinados da lista das fu��es de activa��o
num2 = get(handles.listbox3, 'Value');                 % retorna o �ndice seleccionado da lista das fun��es de treino
...
elseif isempty(handles.idx)
    errordlg('N� de fun��es de activa��o n�o correspondem � topologia da rede neuronal!', 'ERRO');
elseif aux3 > 1
    errordlg('Introduza s� 1 fun��o de treino!','ERRO');
elseif aux2 ~= aux1 + 1
    errordlg('N� de fun��es de activa��o n�o correspondem � topologia da rede neuronal!', 'ERRO');
else
...
handles.idx = get(hObject,'Value');                 % guardar os �ndices das strings seleccionadas
guidata(hObject, handles);
